  ...
  return (
    <>
      <section>
        ...
        <div className="max-w-c-1154 mt-15 pattern-dots pattern-blue-500 pattern-bg-white pattern-size-4 pattern-opacity-10 relative z-50 mx-auto px-4 md:px-8 xl:mt-20 xl:px-0">
