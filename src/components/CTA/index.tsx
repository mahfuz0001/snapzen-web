  ...
  return (
    <>
      ...
      <section className="lg:py-25 xl:py-30 overflow-hidden px-4 py-20 md:px-8 2xl:px-0">
        <div className="max-w-c-1390 px-7.5 md:px-12.5 xl:px-17.5 py-12.5 dark:bg-blacksection dark:stroke-strokedark mx-auto rounded-lg bg-gradient-to-t from-[#F8F9FF] to-[#DEE7FF] dark:bg-gradient-to-t dark:from-transparent dark:to-transparent xl:py-0">
